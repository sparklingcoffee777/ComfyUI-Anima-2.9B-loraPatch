...
Anima-2.9B を 40 ブロックでロードするために [ComfyUI-Anima-2.9B-blocksPatch](https://github.com/sparklingcoffee777/ComfyUI-Anima-2.9B-blocksPatch)（またはオリジナルの ComfyUI-Anima-2.9B）が別途必要です。28 ブロックに切り詰められたモデルに対しては本パッチは働きません。
